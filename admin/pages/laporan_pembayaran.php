...
?>
 <h2 align="Center">Laporan Pembayaran dari Tanggal <?= $tgl_awal;?> sampai <?= $tgl_akhir;?></h2>
...
<?php
  $nomor=1;
  $grand_total=0;
  $sqll = "select * from pembayaran join pendaftaran using (id_pendaftaran) join paket_audio using(id_paket_audio) join customer where pendaftaran.id_customer=customer.id_customer and tanggal between '$tgl_awal' and '$tgl_akhir' order by id_pembayaran desc";
...
?>                                          
                                        <tr>
                                            <td><?= $nomor++;?></td>
                                            <td align="center"><?= $data['tgl_noAntrian'];?></td>
                                            <td align="center"><?= $data['jam_pendaftaran'];?></td>
                                            <td><?= $data['nama'];?></td>
...
<?php
date_default_timezone_set('Asia/Jakarta');
 $header = '<p align="center"><img src="../../images/logo.png" width="250" />
<div align="center">Jl. KSR Dadi Kusmayadi No.45, RT.05/RW.07, Kel. Tengah, Kec. Cibinong, Kabupaten Bogor, Jawa Barat <br> No. HP 087787093352</div>
 </p>
...
$mpdf->SetTitle("Laporan Pembayaran");$mpdf->SetDisplayMode('fullpage');
$mpdf->setHTMLHeader($header);
$mpdf->setHTMLFooter($footer);
$stylesheet = file_get_contents('../../assets/mpdf/mpdf.css');
$mpdf->WriteHTML($stylesheet,1);
$mpdf->WriteHTML($out);
$mpdf->Output("Laporan Pembayaran dari Tanggal $tgl_awal sampai $tgl_akhir.pdf", 'I');
?>
</body>
</html>