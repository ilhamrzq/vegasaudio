          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <li><a href="pendaftaran.php" class="smoothScroll">Pendaftaran</a></li>
               ...
               <div class="row">
                    ...
                    <div class="col-md-7 col-sm-7">
                         <div class="about-info">
                              <h2 class="wow fadeInUp" data-wow-delay="0.6s"><font color="white">Tentang Kami</font></h2>
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   <p><font color="white">VEGAS Audio Variasi merupakan toko yang bergerak di bidang otomotif, yang menyediakan berbagai macam audio mobil dan variasi original yang bergaransi.</font></p>
                                   <p><font color="white">Layanan Dari Toko Kami:</font></p>
                                   <p><font color="white">- Instalasi Audio (Head Unit, Power, Speaker, Subwoofer, Tuning Audio).</font></p>
                                   <p><font color="white">- Produksi Langsung Custom Box Subwoofer.</font></p>
                                   <p><font color="white">- Service Audio.</font></p>
                              </div>
                              <figure class="profile wow fadeInUp" data-wow-delay="1s">
                                   <figcaption>
                                        <h3><font color="white">Dijamin Pemasangan Audio Profesional!</font></h3>
                                   </figcaption>
                              </figure>
                              <figure class="profile wow fadeInUp" data-wow-delay="1s">
                                   <figcaption>
                                        <h3><font color="white">Dijamin Kualitas Audio Terbaik!</font></h3>
                                   </figcaption>
                              </figure>
                              <figure class="profile wow fadeInUp" data-wow-delay="1s">
                                   <figcaption>
                                        <h3><font color="white">Dijamin Suara Jernih dan Detail!</font></h3>
                                   </figcaption>
                              </figure>
                              <figure class="profile wow fadeInUp" data-wow-delay="1s">
                                   <figcaption>
                                        <h3><font color="white">Dijamin Puas Untuk Pengalaman Berkendara!</font></h3>
                                   </figcaption>
                              </figure>
                              <br>
                         </div>
